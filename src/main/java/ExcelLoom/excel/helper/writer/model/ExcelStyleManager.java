...
import ExcelLoom.excel.helper.writer.style.condional.BackgroundColorCondition;
import ExcelLoom.excel.helper.writer.style.condional.ColorCondition;
...
import ExcelLoom.excel.enums.FontStyle;
...
import ExcelLoom.excel.helper.writer.style.ExcelStyleHandler;
...
public class ExcelStyleManager implements ExcelStyleHandler, ConditionalCellStyleHandler, DataStatusConditionHandler {
    ...
    public Font getOrCreateFont(ExcelLoom.excel.annotation.style.Font fontAnnotation) {
    ...
    private record FontKey(ExcelLoom.excel.annotation.style.Font annotation) {
    }
}
