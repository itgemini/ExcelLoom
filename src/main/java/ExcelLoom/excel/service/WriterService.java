 ...
 */
package ExcelLoom.excel.service;
...
import ExcelLoom.excel.annotation.Cell;
import ExcelLoom.excel.annotation.Image;
import ExcelLoom.excel.annotation.Sheet;
import ExcelLoom.excel.exception.WorkbookException;
import ExcelLoom.excel.exception.WriteException;
import ExcelLoom.excel.helper.WorkbookFactory;
import ExcelLoom.excel.helper.WorkbookType;
import ExcelLoom.excel.annotation.style.ExcelStyle;
import ExcelLoom.excel.helper.writer.model.ExcelStyleManager;
import ExcelLoom.excel.helper.writer.model.WritingContext;
import ExcelLoom.excel.helper.writer.style.condional.Registry;

import static ExcelLoom.excel.helper.writer.InitiateExcelStructure.BOOLEAN;
import static ExcelLoom.excel.helper.writer.InitiateExcelStructure.DATE;
import static ExcelLoom.excel.helper.writer.InitiateExcelStructure.DOUBLE;
import static ExcelLoom.excel.helper.writer.InitiateExcelStructure.FLOAT;
import static ExcelLoom.excel.helper.writer.InitiateExcelStructure.IMAGE;
import static ExcelLoom.excel.helper.writer.InitiateExcelStructure.INTEGER;
import static ExcelLoom.excel.helper.writer.InitiateExcelStructure.LOCAL_DATE;
import static ExcelLoom.excel.helper.writer.InitiateExcelStructure.LOCAL_DATE_TIME;
import static ExcelLoom.excel.helper.writer.InitiateExcelStructure.LONG;
import static ExcelLoom.excel.helper.writer.InitiateExcelStructure.TEXT;
import static ExcelLoom.excel.service.Writer.MESSAGE;
