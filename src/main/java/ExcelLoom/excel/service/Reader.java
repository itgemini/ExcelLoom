...
import ExcelLoom.excel.exception.ReadENDException;
import ExcelLoom.excel.exception.ReadException;
...
public class Reader<T> extends ConditionalMarker {
    ...
    public ConcurrentLinkedQueue<T> read() {
        ...
        int headerRowNum = ExcelMetadataReader.getSheetAnnotation(entityClass).headerRowIndex();
