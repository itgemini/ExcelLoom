...
import io.github.itgemini.excel.helper.writer.style.condional.DataStatusCondition;
...
import io.github.itgemini.excel.helper.writer.style.ConditionalCellStyleHandler;
import io.github.itgemini.excel.helper.writer.style.DataStatusConditionHandler;
import io.github.itgemini.excel.helper.writer.style.ExcelStyleHandler;
...
public class ExcelStyleManager implements ExcelStyleHandler, ConditionalCellStyleHandler, DataStatusConditionHandler {
    ...
    public CellStyle getOrCreateStyle(ExcelStyle styleAnnotation, String format) {
    ...
    public Font getOrCreateFont(io.github.itgemini.excel.annotation.style.Font fontAnnotation) {
    ...
    public CellStyle getOrCreateStatusStyle(DataStatusCondition condition, Object value) {
    ...
    public CellStyle getOrCreateConditionalStyle(ColorCondition colorCondition, BackgroundColorCondition backgroundColorCondition, Object value) {
    ...
    private record StyleKey(ExcelStyle annotation, String format) {
    }

    private record FontKey(io.github.itgemini.excel.annotation.style.Font annotation) {
    }
}
