 ...
 */
package io.github.itgemini.excel.service;
...
import io.github.itgemini.excel.annotation.Cell;
import io.github.itgemini.excel.annotation.Image;
import io.github.itgemini.excel.annotation.Sheet;
import io.github.itgemini.excel.exception.WorkbookException;
import io.github.itgemini.excel.exception.WriteException;
import io.github.itgemini.excel.helper.WorkbookFactory;
import io.github.itgemini.excel.helper.WorkbookType;
import io.github.itgemini.excel.annotation.style.ExcelStyle;
import io.github.itgemini.excel.helper.writer.model.ExcelStyleManager;
import io.github.itgemini.excel.helper.writer.model.WritingContext;
import io.github.itgemini.excel.helper.writer.style.condional.Registry;

import static io.github.itgemini.excel.helper.writer.InitiateExcelStructure.BOOLEAN;
import static io.github.itgemini.excel.helper.writer.InitiateExcelStructure.DATE;
import static io.github.itgemini.excel.helper.writer.InitiateExcelStructure.DOUBLE;
import static io.github.itgemini.excel.helper.writer.InitiateExcelStructure.FLOAT;
import static io.github.itgemini.excel.helper.writer.InitiateExcelStructure.IMAGE;
import static io.github.itgemini.excel.helper.writer.InitiateExcelStructure.INTEGER;
import static io.github.itgemini.excel.helper.writer.InitiateExcelStructure.LOCAL_DATE;
import static io.github.itgemini.excel.helper.writer.InitiateExcelStructure.LOCAL_DATE_TIME;
import static io.github.itgemini.excel.helper.writer.InitiateExcelStructure.LONG;
import static io.github.itgemini.excel.helper.writer.InitiateExcelStructure.TEXT;
import static io.github.itgemini.excel.service.Writer.MESSAGE;
    ...
    private <T> void updateTemplate(Field field,T template,org.apache.poi.ss.usermodel.Sheet sheet) throws IllegalAccessException {
        if(field.isAnnotationPresent(Cell.class)) {
            ...
            if(Math.addExact(Math.addExact(cell.firstRow(), cell.lastRow()),Math.addExact(cell.firstColumn(), cell.lastColumn()))==0){
                ...
                cellC.setCellStyle(styleManager.getOrCreateStyle(field.getAnnotation(ExcelStyle.class), cell.format()));
            } else {
